...
> Easy extract text from pdf files

[![PyPI version](https://badge.fury.io/py/easy-pdf-to-text.svg)](https://pypi.org/project/easy-pdf-to-text/)
...
```bash
pip install easy-pdf-to-text
```

## Quick Start

```python
from easy_pdf_to_text import text
...
from easy_pdf_to_text import batch
